...
function _updateFavicon(fg) {
  ...
  if (routeShape) {
    ...
    // The Mythforge spark (matches the ✦ brand mark).
    svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path d='M16 3 L19 13 L29 16 L19 19 L16 29 L13 19 L3 16 L13 13 Z' fill='${fg}'/></svg>`;
  }

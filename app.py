...
# [MYTHFORGE] Document RAG (ChromaDB) cut from the lean build — no vector DB.
rag_manager = None
rag_available = False
...
# [MYTHFORGE-CUT] app.include_router(setup_admin_wipe_routes(session_manager))

# Memory
# [MYTHFORGE-CUT] from routes.memory_routes import setup_memory_routes
# [MYTHFORGE-CUT] memory_router = setup_memory_routes(memory_manager, session_manager, memory_vector=memory_vector)
# [MYTHFORGE-CUT] app.include_router(memory_router)
...
# [MYTHFORGE-CUT] app.include_router(setup_search_routes(config))

# Presets
from routes.preset_routes import setup_preset_routes
app.include_router(setup_preset_routes(preset_manager))

# Character Studio (local "Perchance-style" image→character→chat creator)
from routes.character_studio_routes import setup_character_studio_routes
app.include_router(setup_character_studio_routes(preset_manager))

# Diagnostics
# [MYTHFORGE-CUT] from routes.diagnostics_routes import setup_diagnostics_routes
# [MYTHFORGE-CUT] app.include_router(setup_diagnostics_routes(rag_manager, rag_available, research_handler))

# Cleanup
# [MYTHFORGE-CUT] from routes.cleanup_routes import setup_cleanup_routes
# [MYTHFORGE-CUT] app.include_router(setup_cleanup_routes(session_manager))

# Personal docs
# [MYTHFORGE-CUT] from routes.personal_routes import setup_personal_routes
# [MYTHFORGE-CUT] app.include_router(setup_personal_routes(personal_docs_mgr, rag_manager, rag_available))

# Embedding model management
# [MYTHFORGE-CUT] from routes.embedding_routes import setup_embedding_routes
# [MYTHFORGE-CUT] app.include_router(setup_embedding_routes())
...
# [MYTHFORGE-CUT] from routes.copilot_routes import setup_copilot_routes
# [MYTHFORGE-CUT] app.include_router(setup_copilot_routes())
...
# [MYTHFORGE-CUT] from routes.document_routes import setup_document_routes
# [MYTHFORGE-CUT] document_router = setup_document_routes(session_manager, upload_handler)
# [MYTHFORGE-CUT] app.include_router(document_router)

# Signatures (reusable image stamps)
# [MYTHFORGE-CUT] from routes.signature_routes import setup_signature_routes
...
# [MYTHFORGE-CUT] from routes.assistant_routes import setup_assistant_routes
# [MYTHFORGE-CUT] app.include_router(setup_assistant_routes(task_scheduler))

# Calendar (CalDAV)
# [MYTHFORGE-CUT] from routes.calendar_routes import setup_calendar_routes
# [MYTHFORGE-CUT] calendar_router = setup_calendar_routes()
# [MYTHFORGE-CUT] app.include_router(calendar_router)

# Shell (user-facing command execution)
# [MYTHFORGE-CUT] from routes.shell_routes import setup_shell_routes
# [MYTHFORGE-CUT] app.include_router(setup_shell_routes())

# Cookbook (model download/serve/cache, cookbook state sync)
# [MYTHFORGE-CUT] from routes.cookbook_routes import setup_cookbook_routes
# [MYTHFORGE-CUT] app.include_router(setup_cookbook_routes())

# Hardware model fitting (cookbook "What Fits?" tab)
# [MYTHFORGE-CUT] from routes.hwfit_routes import setup_hwfit_routes
# [MYTHFORGE-CUT] app.include_router(setup_hwfit_routes())

# Model A/B Comparison
# [MYTHFORGE-CUT] from routes.compare_routes import setup_compare_routes
# [MYTHFORGE-CUT] app.include_router(setup_compare_routes(session_manager))
...
# [MYTHFORGE-CUT] from routes.backup_routes import setup_backup_routes
# [MYTHFORGE-CUT] app.include_router(setup_backup_routes(memory_manager, preset_manager, skills_manager))

# [MYTHFORGE-CUT] from routes.font_routes import setup_font_routes
...
# [MYTHFORGE-CUT] app.include_router(setup_note_routes(task_scheduler))

# Email
# [MYTHFORGE-CUT] from routes.email_routes import setup_email_routes
# [MYTHFORGE-CUT] email_router = setup_email_routes()
# [MYTHFORGE-CUT] app.include_router(email_router)
...
# [MYTHFORGE-CUT] from routes.codex_routes import setup_codex_routes, setup_claude_routes
# [MYTHFORGE-CUT] app.include_router(setup_codex_routes(
    # [MYTHFORGE-CUT] email_router=email_router,
    # [MYTHFORGE-CUT] memory_router=memory_router,
    # [MYTHFORGE-CUT] calendar_router=calendar_router,
    # [MYTHFORGE-CUT] document_router=document_router,
# [MYTHFORGE-CUT] ))
# [MYTHFORGE-CUT] app.include_router(setup_claude_routes())

# [MYTHFORGE-CUT] from routes.vault_routes import setup_vault_routes
# [MYTHFORGE-CUT] app.include_router(setup_vault_routes())

# Contacts (CardDAV)
# [MYTHFORGE-CUT] from routes.contacts_routes import setup_contacts_routes
# [MYTHFORGE-CUT] app.include_router(setup_contacts_routes())

# [MYTHFORGE-CUT] from companion import setup_companion_routes
# [MYTHFORGE-CUT] app.include_router(setup_companion_routes())
